...
<div class="row">
    ...
    <div class="col-md-12">
            <div class="tabing-section-order">
                <ul>
                    <li><a href="<?php echo base_url().'admin/state'; ?>" class="acti">All States (<?php echo $total? $total:0;?>)</a></li>
                    <li><a href="<?php echo base_url().'admin/state/blockedstate'; ?>">Blocked States (<?php echo $blocked?>)</a></li>
                </ul>
