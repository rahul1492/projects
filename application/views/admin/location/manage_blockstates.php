...
<div class="row">
    ...
    <div class="col-md-12">
            <div class="tabing-section-order">
                <ul>
                    <li><a href="<?php echo base_url().'admin/state'; ?>">All States (<?php echo $total_states? $total_states:0;?>)</a></li>
                    <li><a href="<?php echo base_url().'admin/state/blockedstate'; ?>" class="acti">Blocked States (<?php echo $blocked?>)</a></li>
                </ul>
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        <?php if($record['is_active']==1){ ?>
                                            <a class="show-tooltip" title="Block" onclick="return confirm('Are you sure you want to block record ?')" href="<?php echo base_url('/admin/state/block/').base64_encode($record['id']) ?>"><i class="fa fa-unlock"></i></a>
                                            <?php }else{ ?>
                                                <a class="show-tooltip" onclick="return confirm('Are you sure you want to unblock record ?')" title="Block" href="<?php echo base_url('/admin/state/unblock/').base64_encode($record['id']) ?>"><i class="fa fa-lock"></i></a>
                                                <?php } ?>
                                            </td>
                                            <td class="visible-md visible-lg">
                                                <div class="btn-group">
                                                    <a class="btn btn-circle show-tooltip" title="View" href="<?php echo base_url('/admin/state/viewcity/').base64_encode($record['id']); ?>"><i class="fa fa-eye"></i></a>
                                                   <!--  <a class="btn btn-sm btn-danger show-tooltip" onclick="return confirm('Are you sure you want to delete record ?')" title="" href="<?php echo base_url('/admin/state/delete/').base64_encode($record['id']); ?>" data-original-title="Delete"><i class="fa fa-trash-o"></i></a> -->
                                                </div>
                                            </td>
                                        </tr>
                                        <?php
