...
<div class="row">
    ...
    <div class="col-md-12">
            <div class="tabing-section-order">
                <ul>
                    <li><a href="<?php echo base_url().'admin/city'; ?>" class="acti">All Cities (<?php echo $total? $total:0;?>)</a></li>
                    <li><a href="<?php echo base_url().'admin/city/blockedcity'; ?>">Blocked Cities (<?php echo $blocked? $blocked:0;?>)</a></li>
                </ul>
