    ...
    <div id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">
                ...
                <a href="<?php echo base_url().ADMIN_CTRL;?>/cities">Location</a>
                <span class="divider"><i class="fa fa-angle-right"></i></span>
            </li>
...
<div class="row">
    ...
    <div class="col-md-12">
            <div class="tabing-section-order">
                <ul>
                    <li><a href="<?php echo base_url().'admin/city'; ?>">All Cities (<?php echo $total_cities? $total_cities:0;?>)</a></li>
                    <li><a href="<?php echo base_url().'admin/city/blockedcity'; ?>" class="acti">Blocked Cities (<?php echo $blocked?>)</a></li>
                </ul>
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        <?php if($record['status']==1){ ?>
                                            <a class="show-tooltip" title="Block" onclick="return confirm('Are you sure you want to block record ?')" href="<?php echo base_url('/admin/city/block/').base64_encode($record['city_id']) ?>"><i class="fa fa-unlock"></i></a>
                                            <?php }else{ ?>
                                                <a class="show-tooltip" onclick="return confirm('Are you sure you want to unblock record ?')" title="Block" href="<?php echo base_url('/admin/city/unblock/').base64_encode($record['city_id']) ?>"><i class="fa fa-lock"></i></a>
                                                <?php } ?>
                                            </td>
                                            <td class="visible-md visible-lg">
                                                <div class="btn-group">
                                                    <a class="btn btn-sm show-tooltip" title="" href="<?php echo base_url('/admin/city/edit/').base64_encode($record['city_id']); ?>" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                                    <!-- <a class="btn btn-sm btn-danger show-tooltip" onclick="return confirm('Are you sure you want to delete record ?')" title="" href="<?php echo base_url('/admin/city/delete/').base64_encode($record['city_id']); ?>" data-original-title="Delete"><i class="fa fa-trash-o"></i></a> -->
                                                </div>
                                            </td>
                                        </tr>
                                        <?php
