...
<div id="main-content">
  ...
  <div class="page-title">
    <div>
      <h1><i class="fa fa-user"></i> Manage Blocked Users</h1>
  ...
  <div id="breadcrumbs">
    <ul class="breadcrumb">
      ...
      <li class="active"> Manage Blocked Users</li>
    </ul>
  </div>
  <!-- END Breadcrumb -->
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tabing-section-order">
                     <ul>
                         <li><a href="<?php echo base_url().'admin/user/manage'; ?>">All Users(<?php echo $total;?>)</a></li>  
                        <li><a class="acti" href="<?php echo base_url().'admin/user/blocked_users'; ?>"  >Blocked Users(<?php echo $total?>)</a></li>
                     </ul>
              ...
              <div class="box">
                ...
                <div class="box-content">
                  ...
                  <div class="table-responsive"> 
                    ...
                    <form method="get" id="search_form" class="form-inline" action="<?php echo base_url().'admin/user/blocked_users' ?>">
                        <div class="form-group">
                          <div class="col-sm-9 col-lg-4 col-sm-offset-3 controls">
                              <input name="search_name" placeholder="Search By Name" value="<?php echo $search_name; ?>" class="form-control" type="text" id="search_name">
                          </div>
                      </div>  
                       <div class="form-group">
                          <div class="col-sm-2 col-lg-4 col-sm-offset-3 controls">
                            <input type="submit" class="btn btn btn-primary" id="search_btn" value="search"  >  
                          </div>
                      </div>  
                  </form>
            <span id="search_error" class="col-sm-offset-1" style="color: red"></span>
                   ...
                   <?php $csrf = array(
                    ...
                    <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                      ...
                      <table class="table table-advance">
                        ...
                        <tbody>
                          ...
                          if(count($dataRes)>0)
                          {
                            ...
                            $i=1;
                            foreach($dataRes as $key => $get_records)
                            {
                              ?>
                              <tr class="table">
                     ...
                     <td>
                          ...
                          <a class="show-tooltip" title="Block" onclick="return confirm('Are You Sure You Want to Unblock User?')" href="<?php echo base_url('/admin/user/block/').base64_encode($get_records['id']) ?>"><i class="fa fa-unlock"></i></a>
                          <?php }else{ ?>
                          <a class="show-tooltip" onclick="return confirm('Are You Sure You Want to Unblock User?')" title="Block" href="<?php echo base_url('/admin/user/unblock/').base64_encode($get_records['id']) ?>"><i class="fa fa-lock"></i></a>
                          <?php } ?>
                      </td>
              ...
              <td class="visible-md visible-lg">
                <div class="btn-group">
                  ...
                  <a class="btn btn-circle show-tooltip" title="View" href="<?php echo base_url().ADMIN_CTRL;?>/user/view/<?php echo $get_records['id'];?>"><i class="fa fa-eye"></i></a>
                    <a class="btn btn-sm btn-danger show-tooltip" onclick="return confirm('Are You Sure Want To Delete User?')" title="" href="<?php echo base_url('/admin/user/delete/').base64_encode($get_records['id']); ?>" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
                </div>
              </td>
            </tr>
            <?php
