  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tabing-section-order">
                      <ul>
                        <li><a class="acti" href="<?php echo base_url().'admin/user/manage'; ?>" >All Users(<?php echo $total;?>)</a></li> 
                         <li><a href="<?php echo base_url().'admin/user/blocked_users'; ?>">Blocked Users(<?php echo $blocked?>)</a></li>  
                    </ul> 
      ...
      <div class="box">
                ...
                <div class="box-content">
                  ...
                  <div class="table-responsive"> 
                    ...
                    <form method="get" id="search_form" class="form-inline" action="<?php echo base_url().'admin/user/manage' ?>" >
                      ...
                      <div class="form-group">
                          <div class="col-sm-2 col-lg-4  col-sm-offset-3 controls">
                              <input type="button" class="btn btn btn-primary" id="search_btn" value="search"  >
                   ...
                   <form name="frm_make_view" id="frm_make_view" method="post" action="<?php echo base_url().ADMIN_CTRL;?>/user/multi_action">
                    ...
                    <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                     ...
                     <td>
                          ...
                          <a class="show-tooltip" title="Block" onclick="return confirm('Are You Sure You Want Block User?')" href="<?php echo base_url('/admin/user/block/').base64_encode($get_records['id']) ?>"><i class="fa fa-unlock"></i></a>
                          <?php }else{ ?>
                          <a class="show-tooltip" onclick="return confirm('Are You Sure You Want Unblock User ?')" title="Block" href="<?php echo base_url('/admin/user/unblock/').base64_encode($get_records['id']) ?>"><i class="fa fa-lock"></i></a>
                          <?php } ?>
                      </td>
              ...
              <td class="visible-md visible-lg">
                <div class="btn-group">
                  ...
                  <a class="btn btn-circle show-tooltip" title="View" href="<?php echo base_url().ADMIN_CTRL;?>/user/view/<?php echo $get_records['id'];?>"><i class="fa fa-eye"></i></a>
                    <a class="btn btn-sm btn-danger show-tooltip" onclick="return confirm('Are You Sure You Want To Delete User?')" title="" href="<?php echo base_url('/admin/user/delete/').base64_encode($get_records['id']); ?>" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
                </div>
              </td>
            </tr>
            <?php
