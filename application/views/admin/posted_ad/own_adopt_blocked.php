...
<div id="main-content">
    ...
    <div class="row">
        ...
        <div class="tabing-section-order">
                <ul>
                    <li><a href="<?php echo base_url().'admin/pets'; ?>">All Pets (<?php echo $total_pets? $total_pets:0;?>)</a></li>
                    <li><a href="<?php echo base_url().'admin/pets/blockedownpets'; ?>" class="acti">Blocked Pets (<?php echo $blocked?>)</a></li>
                            ...
                            <?php if($total>0){
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        ...
                                        <a class="show-tooltip" title="Block" onclick="return confirm('Are you sure you want to block record ?')" href="<?php echo base_url('/admin/pets/block/').base64_encode($record['id']) ?>"><i class="fa fa-unlock"></i></a>
                                        <?php }else{ ?>
                                        <a class="show-tooltip" onclick="return confirm('Are you sure you want to unblock record ?')" title="Block" href="<?php echo base_url('/admin/pets/unblock/').base64_encode($record['id']) ?>"><i class="fa fa-lock"></i></a>
                                        <?php } ?>
                                    </td>
