...
<div id="main-content">
    ...
    <div class="row">
        ...
        <div class="tabing-section-order">
                <ul>
                    <li><a href="<?php echo base_url().'admin/pets'; ?>" class="acti">All Pets (<?php echo $total? $total:0;?>)</a></li>
                    <li><a href="<?php echo base_url().'admin/pets/blockedownpets'; ?>">Blocked Pets (<?php echo $blocked?>)</a></li>
