    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="tabing-section-order">
                <ul>
                    <li><a href="<?php echo base_url().'admin/pets/breedpets'; ?>"">All Pets (<?php echo $total_pets? $total_pets:0;?>)</a></li>
                    <li><a href="<?php echo base_url().'admin/pets/blockedbreedpets'; ?>" class="acti">Blocked Pets (<?php echo $blocked?>)</a></li>
                </ul>
