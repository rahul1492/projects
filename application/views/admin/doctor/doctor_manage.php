...
<div id="main-content">
  ...
  <div class="page-title">
    <div>
      <h1><i class="fa fa-user-md"></i> <?php echo isset($module_name)? $module_name:'Demo Page'; ?></h1>
...
<!--         <div class="box-title">
          ...
          <ul class="nav nav-tabs">
                     ...
                     <ul>
                        <li><a class="acti" href="<?php echo base_url().'admin/doctor/manage'; ?>">All Doctors(<?php echo $total? $total:0;?>)</a></li>
                        <li><a href="<?php echo base_url().'admin/doctor/blocked_doctors'; ?>">Blocked Doctors(<?php echo $blocked?>)</a></li>
                    </ul>
                ...
                <td>
                          ...
                          <?php }else{ ?>
                          <a class="show-tooltip" onclick="return confirm('Are you sure you want to Unblock this Doctor ?')" title="Block" href="<?php echo base_url('/admin/doctor/unblock/').base64_encode($get_records['id']) ?>"><i class="fa fa-lock"></i></a>
                          <?php } ?>
            </td>
