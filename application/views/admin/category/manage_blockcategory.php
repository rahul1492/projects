        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tabing-section-order">
                    <ul>
                        <li><a href="<?php echo base_url().'admin/category'; ?>">All Categories(<?php echo $total_category? $total_category:0;?>)</a></li>
                        <li><a href="<?php echo base_url().'admin/category/blockedcategory'; ?>" class="acti">Blocked Categories(<?php echo $blocked?>)</a></li>
