...
<div class="row">
         <div class="col-md-12">
            <div class="tabing-section-order">
                <ul>
                    <li><a href="<?php echo base_url().'admin/pethair'; ?>" class="acti">All Hair(<?php echo $total? $total:0;?>)</a></li>
                    <li><a href="<?php echo base_url().'admin/pethair/blockedpethair';?>">Blocked Hair(<?php echo $blocked?>)</a></li>
                </ul>
