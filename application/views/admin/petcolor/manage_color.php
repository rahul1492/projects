    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i> Add Color</h3>
                </div>
                   ...
                   'hash' => $this->security->get_csrf_hash()); ?>
                    <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                       ...
                       <div class="form-group col-md-5 col-sm-4" >
                          <label class="col-sm-5 col-lg-5 control-label" for="color_name">Color<span style="color:red">*</span></label>
                          <div class="col-sm-7 col-md-7 controls">

                             <input class="form-control show-tooltip" type="text" name="color_name" id="color_name" data-rule-required="true" data-original-title="Add Color Name" data-trigger="hover" placeholder="Enter Color Name" />
                             <div style="color:red;">
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-sm-4 col-md-4 controls">
                              ...
                              <button type="submit" name="add_color" id="add_color" class="btn btn-primary"><i class="fa fa-check"></i> Submit</button>
                            </div>   
...
<div class="row">
         ...
         <div class="col-md-12">
            <div class="tabing-section-order">
                <ul>
                    <li><a href="<?php echo base_url().'admin/petcolor'; ?>" class="acti">All Color(<?php echo $total? $total:0;?>)</a></li>
                    <li><a href="<?php echo base_url().'admin/petcolor/blockedpetcolor'; ?>">Blocked Color(<?php echo $blocked?>)</a></li>
                </ul>
    ...
    <div class="col-md-12">
        <div class="box ">
            <div class="box-content">
                ...
                <form method="get" id="search_form" class="form-inline" action="<?php echo base_url().'admin/petcolor'?>">
                    <div class="form-group">
                      <div class="col-sm-9 col-lg-4 col-sm-offset-3 controls">
                          <input name="search_name" placeholder="Search By Name" value="<?php echo isset($_GET['search_name'])? $_GET['search_name']:''; ?>" data-rule-required="true" class="form-control" name="search_name" type="text" id="search_name">
                      </div>
              ...
              <form name="frm_make_view" id="frm_make_view" method="post" action="<?php echo base_url().ADMIN_CTRL;?>/petcolor/multi_action">
                        ...
                        <?php if($total>0){
                            ...
                            foreach ($records as $record) { ?>
                                <tr class="">
                                    ...
                                    <td>
                                        <?php if($record['color_status']==1){ ?>
                                            <a class="show-tooltip" title="Block" onclick="return confirm('Are you sure you want to Block Record?')" href="<?php echo base_url('/admin/petcolor/block/').base64_encode($record['id']) ?>"><i class="fa fa-unlock"></i></a>
                                            <?php }else{ ?>
                                                <a class="show-tooltip" onclick="return confirm('Are you sure you want to Unblock Record ?')" title="Block" href="<?php echo base_url('/admin/petcolor/unblock/').base64_encode($record['id']) ?>"><i class="fa fa-lock"></i></a>
                                                <?php } ?>
                                            </td>
                                            <td class="visible-md visible-lg">
                                                <div class="btn-group">
                                                    <a class="btn btn-sm show-tooltip" title="" href="<?php echo base_url('/admin/petcolor/edit/').base64_encode($record['id']); ?>" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                                    <a class="btn btn-sm btn-danger show-tooltip" onclick="return confirm('Are you sure you want to delete record ?')" title="" href="<?php echo base_url('/admin/petcolor/delete/').base64_encode($record['id']); ?>" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php
