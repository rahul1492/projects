...
<div id="main-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i> Add Age Type</h3>
                </div>
                <div class="box-content" style="padding: 25px">
                    ...
                    <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                           ...
                           <div class="form-group col-md-5 col-sm-4">
                              <label class="col-sm-5 col-lg-5 control-label" for="category_name">Age Type Name<span style="color: red">*</span></label>
                              <div class="col-sm-5 col-md-5 controls">
                                 <input class="form-control show-tooltip" type="text" name="age_type" id="category_name" data-rule-required="true" data-original-title="Add Age Type Name" data-trigger="hover" placeholder="Enter Age Type Name"/>
...
<!--     <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="tabing-section-order">
                <ul>
                    <li><a href="<?php echo base_url().'admin/petage'; ?>" class="acti">All Age(<?php echo $total? $total:0;?>)</a></li>
                    <li><a href="<?php echo base_url().'admin/petage/blockedpetage'; ?>">Blocked Age(<?php echo $blocked?>)</a></li>
                </ul>
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-content">
              ...
              <form name="frm_make_view" id="frm_make_view" method="post" action="<?php echo base_url().ADMIN_CTRL;?>/petage/multi_action">
              <?php $csrf = array(
                'name' => $this->security->get_csrf_token_name(),
                'hash' => $this->security->get_csrf_hash()); ?>
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        <?php if($record['status']==1){ ?>
                                            <a class="show-tooltip" title="Block" onclick="return confirm('Are you sure you want to Block this Record ?')" href="<?php echo base_url('/admin/petage/block/').base64_encode($record['id']) ?>"><i class="fa fa-unlock"></i></a>
                                            <?php }else{ ?>
                                                <a class="show-tooltip" onclick="return confirm('Are you sure you want to Unblock this Record ?')" title="Block" href="<?php echo base_url('/admin/petage/unblock/').base64_encode($record['id']) ?>"><i class="fa fa-lock"></i></a>
                                                <?php } ?>
                                            </td>
                                            <td class="visible-md visible-lg">
                                                <div class="btn-group">
                                                    <a class="btn btn-sm show-tooltip" title="" href="<?php echo base_url('/admin/petage/edit/').base64_encode($record['id']); ?>" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                                    <a class="btn btn-sm btn-danger show-tooltip" onclick="return confirm('Are you sure you want to Delete this Record ?')" title="" href="<?php echo base_url('/admin/petage/delete/').base64_encode($record['id']); ?>" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php
