...
<!--             <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="tabing-section-order">
                <ul>
                    <li><a href="<?php echo base_url().'admin/petage'; ?>" >All Age(<?php echo $total? $total:0;?>)</a></li>
                    <li><a href="<?php echo base_url().'admin/petage/blockedpetage'; ?>" class="acti">Blocked Age(<?php echo $blocked?>)</a></li>
                </ul>
