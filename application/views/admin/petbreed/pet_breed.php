...
<div class="row">
         ...
         <div class="col-md-12">
            <div class="tabing-section-order">
                <ul>
                    <li><a href="<?php echo base_url().'admin/petbreed'; ?>" class="acti">All Pet Breed(<?php echo $total? $total:0;?>)</a></li>
                    <li><a href="<?php echo base_url().'admin/petbreed/blockedpetbreed'; ?>">Blocked Pet Breed(<?php echo $blocked?>)</a></li>
                </ul>
    ...
    <div class="col-md-12">
        <div class="box ">
            <div class="box-content">
                ...
                <form method="get" id="search_form" class="form-inline" action="<?php echo base_url().'admin/petbreed' ?>">
                    <div class="form-group">
